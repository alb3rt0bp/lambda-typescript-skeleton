...
describe('Index tests and input validations for userDetail service', () => {
    ...
    it('KO, missing given_name', async (done) => {
        ...
        try {
            const result =  await component.userDetail(eventDummy, {} as AWSLambda.Context, null as unknown as AWSLambda.Callback);
