'use strict'
import { patchApiCall, externalResponse } from '../../../../utils/restClient'
...
describe('Patch API Call', function () {
    let logData: LogData
   ...
   it('KO, Unexpected Error calling service', function (done) {
        ...
        spyOn(axios,'patch').and.callFake(function(url:string, config: AxiosRequestConfig | undefined): Promise<any>{
            expect(url).toBe("")
        ...
        let result = patchApiCall("", {}, {'content-type': "application/x-www-form-urlencoded"}, logData)
   ...
   it('OK with no headers', function (done) {
        ...
        let result = patchApiCall("", {}, undefined, logData)
