'use strict';
import { postApiCall, externalResponse } from '../../../../utils/restClient'
...
describe('Post API Call', function () {
    let logData: LogData;
    ...
    it('KO, Unexpected Error calling service', function (done) {
        ...
        spyOn(axios,'post').and.callFake(function(url:string, config: AxiosRequestConfig | undefined): Promise<any>{
            expect(url).toBe("")
        ...
        let result = postApiCall("", {}, {'content-type': "application/x-www-form-urlencoded"}, {}, logData);
    ...
    it('OK with no headers', function (done) {
        ...
        let result = postApiCall("", {}, undefined, {}, logData);
